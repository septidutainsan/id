...
(function () {
  function init() {
    ...
    window.openWA = function openWA(topic) {
      const phone = '6281268888239';
      const text = encodeURIComponent('Halo, saya punya pertanyaan mengenai destinasi ' + topic);
    ...
    (function () {
      const translations = {
        en: {
          ...
          whyDesc: 'We are a trusted travel partner in Indonesia with over 7 years of experience. Our flexible services handle groups large and small, corporate and private tours. With custom itineraries or ready-made packages, we ensure your trip is safe, comfortable
